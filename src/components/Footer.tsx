          ...
          <div className="space-y-6">
            ...
            <div className="w-full space-y-6">
              ...
              <div className="flex items-center gap-4 pt-4">
                ...
                <a href="https://www.instagram.com" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-white/5 border border-white/10 flex items-center justify-center hover:bg-[#E4405F] hover:border-[#E4405F] hover:-translate-y-1 transition-all group shadow-sm" aria-label="Instagram">
                  <svg className="w-4 h-4 text-[#b2dfdb] group-hover:text-white fill-current transition-colors" viewBox="0 0 24 24">
