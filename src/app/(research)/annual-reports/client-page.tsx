...
export default function AnnualReportsClientPage({ pageData }: { pageData: any }) {
  const options = [
    {
        "name": "About Us",
        "href": "/about",
            ...
            <div className="bg-white rounded-3xl shadow-[0_8px_40px_rgb(0,0,0,0.03)] border border-slate-100/60 p-6 sm:p-10 md:p-14">
              ...
              {pageData.image && (
                <div className="mb-10 rounded-2xl overflow-hidden border border-slate-200">
                  <img src={pageData.image} alt={pageData.title || "Annual Reports"} className="w-full h-auto object-contain max-h-[500px] bg-slate-50" />
                </div>
              )}
