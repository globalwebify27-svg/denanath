            ...
            <div className="bg-white rounded-3xl shadow-[0_8px_40px_rgb(0,0,0,0.03)] border border-slate-100/60 px-6 pt-3 pb-6 sm:px-10 sm:pt-4 sm:pb-10 md:px-14 md:pt-4 md:pb-8">
              ...
              {pageData.image && (
                <div className="mb-10 rounded-2xl overflow-hidden border border-slate-200">
                  <img src={pageData.image} alt={pageData.title || "Contact Us"} className="w-full h-auto object-contain max-h-[500px] bg-slate-50" />
                </div>
              )}
              
              {pageData.content ? (
                <div 
                  className="text-slate-600 [&_*]:!text-base [&_*]:!leading-[31px] [&_*]:!font-medium [&_a]:!font-bold [&_a_*]:!font-bold [&_a[href*='pethev']]:!text-[#3C99A3] [&_a[href*='pethev']_*]:!text-[#3C99A3] [&_.fa-envelope]:!text-[#3C99A3] [&_svg]:!text-[#3C99A3]" 
                  ...
                  onClick={(e) => {
                    ...
                    if (anchor && anchor.href && anchor.href.startsWith('mailto:')) {
                      e.preventDefault();
                      // Open in same window to trigger mail client without leaving a blank tab
