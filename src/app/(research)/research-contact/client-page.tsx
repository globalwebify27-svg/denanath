        ...
        <div className="flex flex-col lg:flex-row gap-8 xl:gap-12 items-start">
          ...
          <div className="w-full flex-1 min-w-0">
            <div className="bg-white rounded-3xl shadow-[0_8px_40px_rgb(0,0,0,0.03)] border border-slate-100/60 px-6 pt-3 pb-6 sm:px-10 sm:pt-4 sm:pb-10 md:px-14 md:pt-4 md:pb-8">
              ...
              {pageData.content ? (
                <div 
                  className="text-slate-600 [&_*]:!text-[18px] [&_*]:!leading-[31px] [&_*]:!font-medium [&_a]:!font-bold [&_a_*]:!font-bold [&_a[href*='pethev']]:!text-[#3C99A3] [&_a[href*='pethev']_*]:!text-[#3C99A3] [&_.fa-envelope]:!text-[#3C99A3] [&_svg]:!text-[#3C99A3]" 
