    ...
    <div className="min-h-screen bg-[#f8fafc] font-sans selection:bg-teal-500/30">
      ...
      <div className="w-full bg-[#002b5c] relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3 md:py-4 relative z-10">
          ...
          <h1 className="text-[40px] leading-tight font-extrabold text-white tracking-tight">Accreditations</h1>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-3 pb-8 md:pt-5 md:pb-12">
        <div className="flex flex-col lg:flex-row gap-8 xl:gap-12 items-start">
          ...
          {/* Dynamic Sidebar */}
          <DynamicSidebar categoryName="About Us" activeHref="/accreditations" />
