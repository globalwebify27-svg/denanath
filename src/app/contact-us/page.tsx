            ...
            <div className="space-y-8">
              ...
              <div className="bg-white border border-slate-200 rounded-2xl overflow-hidden shadow-sm">
                ...
                <div className="divide-y divide-slate-100">
                  ...
                  <div className="p-4 sm:p-5 flex flex-col sm:flex-row sm:items-center justify-between gap-2 hover:bg-slate-50 transition-colors">
                    <div className="flex items-center gap-3">
                      <ShieldAlert className="w-5 h-5 text-red-500" />
                      <span className="font-extrabold text-slate-800">Emergency Services</span>
                    </div>
                    <div className="text-sm font-medium text-slate-600 text-right">
                      <span className="text-[#007a87] font-bold">GS:</span> +91 20 4015 1024 / 1027 / 1065
                    </div>
                  </div>

                  <div className="p-4 sm:p-5 flex flex-col sm:flex-row justify-between gap-4 hover:bg-slate-50 transition-colors">
                    <div className="flex items-center gap-3 shrink-0">
                      <HeartPulse className="w-5 h-5 text-teal-600" />
                      <span className="font-extrabold text-slate-800">Intensive Care Unit</span>
                    </div>
                  ...
                  <div className="p-4 sm:p-5 flex flex-col sm:flex-row justify-between gap-4 hover:bg-slate-50 transition-colors">
                    <div className="flex items-center gap-3 shrink-0">
                      ...
                      <span className="font-extrabold text-slate-800">Paediatric / Neo Natal</span>
                    </div>
                    <div className="text-sm font-medium text-slate-600 text-left sm:text-right space-y-1">
                  ...
                  <div className="p-4 sm:p-5 flex flex-col sm:flex-row justify-between gap-4 hover:bg-slate-50 transition-colors">
                    <div className="flex items-center gap-3 shrink-0">
                      ...
                      <span className="font-extrabold text-slate-800">Blood Bank</span>
                    </div>
                    <div className="text-sm font-medium text-slate-600 text-left sm:text-right space-y-1">
                  ...
                  <div className="p-4 sm:p-5 flex flex-col sm:flex-row justify-between gap-4 hover:bg-slate-50 transition-colors">
                    <div className="flex items-center gap-3 shrink-0">
                      ...
                      <span className="font-extrabold text-slate-800">Pharmacy</span>
                    </div>
                    <div className="text-sm font-medium text-slate-600 text-left sm:text-right space-y-1">
                  ...
                  <div className="p-4 sm:p-5 flex flex-col sm:flex-row justify-between gap-4 hover:bg-slate-50 transition-colors">
                    <div className="flex items-center gap-3 shrink-0">
                      ...
                      <span className="font-extrabold text-slate-800">Heart Hot Line</span>
                    </div>
                    <div className="text-sm font-medium text-slate-600 text-left sm:text-right">
                      <span className="text-[#007a87] font-bold">GS:</span> +91 20 4015 1540
                    </div>
                  </div>
                  ...
                  <div className="p-4 sm:p-5 flex flex-col sm:flex-row justify-between gap-4 hover:bg-slate-50 transition-colors">
                    <div className="flex items-center gap-3 shrink-0">
                      ...
                      <span className="font-extrabold text-slate-800">IVF Clinic</span>
                    </div>
                    <div className="text-sm font-medium text-slate-600 text-left sm:text-right space-y-1">
