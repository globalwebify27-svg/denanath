...
export default function PatientPortalClient({ initialData }: { initialData: any }) {
              ...
              <div className="max-w-xl mx-auto bg-white border border-slate-200 rounded-3xl shadow-sm overflow-hidden">
                ...
                <div className="p-8 pb-6 border-b border-slate-100 flex flex-col items-center text-center bg-gradient-to-b from-slate-50 to-white">
                  <div className="flex gap-4 w-full justify-between mb-8">
                    <a href={data.googlePlayUrl} target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 bg-black text-white px-3 py-1.5 rounded-lg text-xs font-semibold hover:bg-slate-800 transition-colors shadow-sm">
                    ...
                    <a href={data.appStoreUrl} target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 bg-black text-white px-3 py-1.5 rounded-lg text-xs font-semibold hover:bg-slate-800 transition-colors shadow-sm">
                      <Smartphone className="w-4 h-4" />
                      <div className="text-left leading-tight">
                    ...
                    <div className="animate-in fade-in slide-in-from-bottom-4 duration-500">
                      ...
                      <div className="mt-10 pt-8 border-t border-slate-100 bg-slate-50/50 rounded-2xl p-6">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-y-3 gap-x-6 text-sm text-slate-600 font-medium">
                          {data.portalFeatures.map((item: string, idx: number) => (
                      ...
                      <form className="space-y-6">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                          ...
                          <div className="md:col-span-2">
                            ...
                            <div className="relative">
                              <input type="tel" placeholder="Mobile Number" maxLength={10} pattern="[0-9]{10}" title="Please enter a valid 10-digit mobile number" onInput={(e) => { e.currentTarget.value = e.currentTarget.value.replace(/[^0-9]/g, ''); }} className="w-full px-4 py-3.5 pl-11 rounded-xl border border-slate-200 focus:outline-none focus:ring-2 focus:ring-teal-500 focus:border-teal-500 bg-white shadow-sm transition-all text-slate-700 font-medium placeholder-slate-400" required />
