...
export default function JeevanRekhaPage() {
  const options = [
    {
        "name": "Academics",
        "href": "/academics",
              ...
              <div className="prose prose-slate max-w-none prose-p:leading-relaxed prose-p:text-slate-700 space-y-8">
                ...
                <div className="flex items-start gap-4 p-6 bg-teal-50/50 rounded-2xl border border-teal-100">
                  ...
                  <p className="m-0 font-medium text-slate-700">
                    With expert trainers and small batches, you gain practical, life-saving skills in just four hours. <span className="text-[#007a87] font-bold">Register soon—limited seats available.</span>
                  </p>
                </div>
                  ...
                  <div className="space-y-4">
                    <div className="flex items-start gap-4">
                      ...
                      <p className="m-0 text-slate-600">
                        Dr. Indumati Amodkar Simulation Center,<br/>
                        Deenanath Mangeshkar Hospital and Research Center, Pune
                      </p>
                    </div>
                    <div className="flex items-center gap-4">
                      <Phone className="w-5 h-5 text-teal-500 shrink-0" />
                      <p className="m-0 text-slate-600 font-medium flex items-center gap-2">
                        <a href="tel:02049154402" className="hover:text-[#007a87] hover:underline">020-49154402/3/4</a>
                        <span className="text-slate-300 font-normal">|</span>
                        <a href="tel:9356684381" className="hover:text-[#007a87] hover:underline">9356684381</a>
                      </p>
                    </div>
                    <div className="flex items-center gap-4">
                      <Mail className="w-5 h-5 text-teal-500 shrink-0" />
                      <a href="mailto:simcenter@dmhospital.org" className="text-[#007a87] font-bold hover:underline">
                        simcenter@dmhospital.org
                      </a>
                    </div>
                  </div>
                </div>
