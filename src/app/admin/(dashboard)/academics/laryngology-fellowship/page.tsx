...
import LaryngologyFellowshipClientForm from "./client-form";

export const dynamic = "force-dynamic";

export default async function AdminLaryngologyFellowshipPage() {
  ...
  async function saveData(formData: FormData) {
    ...
    try {
      ...
      const aboutEditorContent = formData.get("aboutContentEditor") as string;
      if (aboutEditorContent !== null && aboutEditorContent !== undefined) {
        parsed.aboutContent = aboutEditorContent;
      }
      ...
      await prisma.siteSetting.upsert({
        where: { key: 'page_academics_laryngology_fellowship' },
        update: { value: finalJson },
        create: { key: 'page_academics_laryngology_fellowship', value: finalJson }
      });
      revalidatePath("/admin/academics/laryngology-fellowship");
      revalidatePath("/laryngology-fellowship");
      revalidatePath("/academics");
    } catch (e) {
      console.error("Failed to save Laryngology Fellowship settings", e);
    }
  }
  ...
  return (
    <div className="p-4 md:p-8 max-w-6xl mx-auto pb-32">
      <form action={saveData} className="space-y-8">
        ...
        <div className="mb-10 flex flex-col lg:flex-row justify-between items-start lg:items-center gap-6 bg-white p-6 md:p-10 rounded-3xl shadow-sm border border-slate-100 relative overflow-hidden group">
          ...
          <div className="z-10 relative">
            ...
            <p className="text-[15px] font-medium text-slate-500 max-w-xl leading-relaxed">
              Manage Laryngology Fellowship page content, quick links, RCS references, and SEO metadata.
            </p>
          </div>
        ...
        {/* Form Content */}
        <LaryngologyFellowshipClientForm initialData={pageData} />
