...
export default async function AdminTrainingProgramsPage() {
  ...
  return (
    <div className="p-8 max-w-5xl mx-auto">
      <div className="mb-8">
        <h1 className="text-[36px] font-[800] leading-[40px] text-[#002b5c] tracking-tight mb-2">Training Programs</h1>
        <p className="text-[14px] font-[600] text-gray-500">Manage training programs list.</p>
      </div>
