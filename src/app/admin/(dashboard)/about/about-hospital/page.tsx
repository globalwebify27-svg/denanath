...
export default async function AdminAboutHospitalPage() {
  ...
  if (Object.keys(aboutData).length === 0) {
    aboutData = {
        ...
        qualityPolicy: `Deenanath Mangeshkar Hospital believes in highest professional competence with a human touch and will deliver excellent medical treatment to everyone. We will follow rational and ethical medical practices implicitly. We are committed to deliver quality healthcare.`,
        qualityObjective: `We will sincerely work together as a team to make Deenanath Mangeshkar Hospital a medical centre of international reputation. We will provide excellent health education pre and post hospital care. We will not discriminate between rich and poor with regard to medical treatment.`,
        coreValues: [
    "Compassionate Care",
    "Patient Safety",
    "Integrity & Ethics",
