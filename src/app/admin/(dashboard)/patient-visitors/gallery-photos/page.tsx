...
const rawJson = formData.get("galleryPhotosJson") as string;
    ...
    try {
      ...
      await prisma.siteSetting.upsert({
        ...
        create: { key: 'page_gallery_photos', value: finalJson }
      });
