...
export default async function AdminHealthPackagesPage() {
  ...
  async function saveHealthPackagesData(formData: FormData) {
    ...
    try {
      ...
      await prisma.siteSetting.upsert({
        ...
        create: { key: 'page_health_packages', value: finalJson }
      });
  ...
  return (
    <div className="p-4 md:p-8 max-w-6xl mx-auto pb-32">
      <form action={saveHealthPackagesData} className="space-y-8">
