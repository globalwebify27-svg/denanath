...
export default async function AdminGalleryVideosPage() {
  ...
  async function saveGalleryVideosData(formData: FormData) {
    ...
    try {
      ...
      await prisma.siteSetting.upsert({
        ...
        create: { key: 'page_gallery_videos', value: finalJson }
      });
  ...
  return (
    <div className="p-4 md:p-8 max-w-6xl mx-auto pb-32">
      <form action={saveGalleryVideosData} className="space-y-8">
