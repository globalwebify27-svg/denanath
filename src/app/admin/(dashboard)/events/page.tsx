  ...
  async function saveEventsData(formData: FormData) {
    ...
    try {
      ...
      await prisma.siteSetting.upsert({
        ...
        create: { key: 'page_events', value: finalJson }
      });
      revalidatePath("/admin/events");
      revalidatePath("/events");
    } catch (e) {
      console.error("Invalid JSON provided for events");
    }
  }

  return (
    <div className="p-4 md:p-8 max-w-6xl mx-auto pb-32">
      <form action={saveEventsData} className="space-y-8">
        ...
        <div className="mb-10 flex flex-col lg:flex-row justify-between items-start lg:items-center gap-6 bg-white p-6 md:p-10 rounded-3xl shadow-sm border border-slate-100 relative overflow-hidden group">
          ...
          <div className="z-10 relative">
            ...
            <p className="text-[15px] font-medium text-slate-500 max-w-xl leading-relaxed">
              Manage the event overview, agenda, gallery and organizers dynamically.
            </p>
          </div>
