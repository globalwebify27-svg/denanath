    ...
    <div className="p-8 max-w-4xl mx-auto">
      <div className="mb-8 flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div>
          ...
          <h1 className="text-[36px] font-[900] text-[#002b5c] tracking-tight mb-2">Edit Service</h1>
          <p className="text-[15px] font-[500] text-gray-500">Update details for {service.title}.</p>
        </div>
        
        <form action={deleteService}>
          <button
            type="submit"
            className="flex items-center gap-2 bg-rose-50 text-rose-600 px-5 py-2.5 rounded-xl hover:bg-rose-100 transition-all font-[700] text-[13px] tracking-wide"
          >
            <Trash2 size={16} />
            <span>Delete</span>
          </button>
      ...
      <form action={updateService} className="bg-white rounded-3xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-gray-100 p-8 md:p-10">
