    ...
    <div className="p-8">
      ...
      <div className="bg-white p-2 rounded-2xl shadow-[0_4px_20px_rgb(0,0,0,0.03)] border border-gray-100 mb-6 flex flex-col md:flex-row gap-4 items-center justify-between">
        <form method="GET" action="" className="flex items-center gap-2 w-full md:max-w-xl">
          ...
          <button
            type="submit"
            className="px-5 py-3 border border-gray-300 hover:border-[#007a87] text-gray-700 hover:text-[#007a87] text-[13px] font-[700] rounded-xl transition-all duration-200 whitespace-nowrap bg-white hover:shadow-sm shrink-0"
          >
            Search
          </button>
        </form>
