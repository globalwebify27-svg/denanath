...
export default async function AdminServicesPage({
  ...
  const setting = await prisma.siteSetting.findUnique({ where: { key: 'page_services' } });
  let seoData: any = {};
    ...
    <div className="p-8">
      ...
      <div className="mb-10 flex flex-col lg:flex-row justify-between items-start lg:items-center gap-6 bg-white p-6 md:p-10 rounded-3xl shadow-sm border border-slate-100 relative overflow-hidden group">
        ...
        <div className="z-10 shrink-0 mt-4 lg:mt-0">
          ...
          >
            <Plus size={20} strokeWidth={2.5} /> Add New Service
          </Link>
        </div>
      ...
      <InlineSeoForm settingKey="page_services" initialData={seoData} />
      ...
      <div className="bg-white p-2 rounded-2xl shadow-[0_4px_20px_rgb(0,0,0,0.03)] border border-gray-100 mb-6 flex flex-col md:flex-row gap-4 items-center justify-between">
        <form method="GET" action="" className="flex items-center gap-2 w-full md:max-w-xl">
          ...
          <button
            type="submit"
            className="px-5 py-3 border border-gray-300 hover:border-[#007a87] text-gray-700 hover:text-[#007a87] text-[13px] font-[700] rounded-xl transition-all duration-200  bg-white hover:shadow-sm shrink-0"
          >
            Search
          </button>
        </form>
          ...
          <table className="break-words w-full text-left border-collapse table-fixed  ">
            <thead>
              <tr className="bg-gradient-to-r from-gray-50 to-white border-b border-gray-100">
                <th className="p-2 font-[800] text-[12px] uppercase tracking-widest text-gray-400 w-[30%]">Service Title</th>
                <th className="p-2 font-[800] text-[12px] uppercase tracking-widest text-gray-400 w-[20%]">Status</th>
                <th className="p-2 font-[800] text-[12px] uppercase tracking-widest text-gray-400 w-[40%]">Items Included</th>
              ...
              {services.length === 0 && (
                <tr>
                  <td colSpan={4} className="p-16 text-center">
                    ...
                    <p className=" font-[800] text-gray-800 tracking-tight">No services found</p>
