      ...
      <div className="relative bg-gradient-to-r from-[#004d56] to-[#007b8a] pt-24 pb-16 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <nav className="flex items-center gap-2 text-sm text-[#b2dfdb] mb-8">
            ...
            <span className="text-white font-medium">EventsDetails</span>
          </nav>
          ...
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
            <div className="max-w-3xl">
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/10 border border-white/20 text-white text-sm font-semibold mb-6 backdrop-blur-sm">
                ...
                <span>Saturday March 21, 2026</span>
              </div>
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white leading-tight tracking-tight">
                Diabetes Nursing <br className="hidden md:block"/>Conference 2026
              </h1>
            </div>
          ...
          <div className="lg:col-span-2 space-y-12">
            ...
            <section className="bg-white rounded-3xl p-8 md:p-10 shadow-sm border border-slate-100 relative overflow-hidden group hover:shadow-md transition-shadow">
              ...
              <div className="space-y-4 text-slate-600 leading-relaxed text-[17px]">
                <p>
                  The Diabetes Nursing Conference was a highly successful one-day event dedicated to advancing the knowledge, skills, and professional development of nurses specializing in diabetes care. This premier gathering brought together <strong className="text-slate-800">400 healthcare professionals, researchers, and educators</strong> committed to improving diabetes management through innovative practices and evidence-based approaches.
                </p>
                <p>
                ...
                <div className="bg-amber-50 rounded-2xl p-6 mt-6 border border-amber-100 flex items-start gap-4">
          ...
          <div className="space-y-8">
            ...
            <div className="bg-white rounded-3xl p-8 shadow-sm border border-slate-100">
              ...
              <div className="space-y-6">
                <div className="border-l-2 border-[#00a69c] pl-4">
                  <p className="font-bold text-slate-800 text-lg">Mrs. Revati Mangaonkar</p>
                  <p className="text-sm text-slate-500 font-medium">Director Nursing (Chairperson)</p>
                </div>
                <div className="border-l-2 border-[#00a69c] pl-4">
                  <p className="font-bold text-slate-800 text-lg">Mrs. Komal Parab</p>
                  <p className="text-sm text-slate-500 font-medium">Assistant Director Nursing (Organize Secretary)</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-3xl p-8 shadow-sm border border-slate-100">
              ...
              <div className="flex flex-col gap-4">
                {['Diabetes-Nursing-Conference1.jpg', 'Diabetes-Nursing-Conference2.jpg'].map((img, idx) => (
                  <div 
                    key={idx} 
                  ...
                  >
                    <img 
                      src={`/images/${img}`} 
                      alt={`Diabetes Nursing Conference moment ${idx + 1}`}
            ...
            <div className="overflow-x-auto">
              <table className="w-full text-left border-collapse">
                ...
                <tbody className="divide-y divide-slate-100">
                  ...
                  {[
                    {
                      topic: "Managing Diabetic Emergencies",
                      speaker: "Ms. Shubhangi Khandve",
                      role: "Head Nurse – Intensive Care Unit, DMH, Pune."
                    },
                    {
                      topic: "All About Insulin – Insulin Therapy Management, Safe Administration, and Patient Education",
                      speaker: "Ms. Priti Dhage",
                      role: "Associate Nursing Superintendent – Medical & Surgical, DMH, Pune"
                    },
                    {
                      topic: "Lifestyle Modification – Nurse’s Role in Diabetes Care",
                      speaker: "Dr. Aditya Deshpande",
                      role: "Hononary Consultant Endocrinology, DMH, Pune."
                    },
                    {
                      topic: "Wound Care Management for Diabetic Foot Ulcers",
                      speaker: "Ms. Sayali Rawade",
                      role: "Therapy Specialist, B Barun Medical India Pvt, Ltd., Pune"
                    },
                    {
                      topic: "Patient Education – Diet and Glucose Monitoring",
                      speaker: "Ms. Swati Chile",
                      role: "Clinical Instructor – Ward, DMH, Pune"
                    }
                  ].map((row, idx) => (
