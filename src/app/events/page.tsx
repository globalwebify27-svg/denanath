...
import EventsListClientPage from "./client-page";
...
function normalizeEventsData(raw: any) {
  ...
  if (raw.title) {
    ...
    return {
      ...
      events: [{ id: "event-legacy", ...eventData }]
    };
  }
...
export default async function EventsPage() {
  ...
  return <EventsListClientPage events={data.events || []} pageData={{ pageTitle: data.pageTitle, bannerImage: data.bannerImage }} />;
}
