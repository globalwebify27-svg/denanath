...
const newHtml = `<div class="space-y-8 text-slate-700">
  ...
  <section>
    ...
    <h4 class="font-bold text-[#002b5c] mb-2 mt-4 text-lg">Operation theatres</h4>
    ...
    <h4 class="font-bold text-[#002b5c] mb-2 mt-4 text-lg">Sports Rehab Center</h4>
    ...
    <h4 class="font-bold text-[#002b5c] mb-2 mt-4 text-lg">Academic Excellence</h4>
