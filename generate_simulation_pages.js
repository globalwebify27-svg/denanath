...
const pages = [
  { path: 'lab-1', title: 'Simulation Lab 1', key: 'page_simulation_lab1' },
  { path: 'lab-2', title: 'Simulation Lab 2', key: 'page_simulation_lab2' },
  { path: 'lab-3', title: 'Simulation Lab 3', key: 'page_simulation_lab3' },
  { path: 'other-facilities', title: 'Other Facilities on 14th Floor', key: 'page_simulation_other_facilities' }
];

const template = (title, key) => `import { prisma } from "@/lib/prisma";
    ...
    <div className="min-h-screen bg-[#f8fafc] font-sans selection:bg-teal-500/30">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-10 md:py-16">
        ...
        <div className="bg-white rounded-3xl shadow-sm border border-slate-200 p-8 md:p-12">
          ...
          {pageData.content ? (
            <div className="prose prose-slate max-w-none prose-p:leading-relaxed prose-headings:text-[#002b5c] text-slate-700" dangerouslySetInnerHTML={{ __html: pageData.content }} />
          ) : (
...
pages.forEach(p => {
  const dir = path.join(__dirname, 'src', 'app', '(academics)', 'simulation-center', p.path);
