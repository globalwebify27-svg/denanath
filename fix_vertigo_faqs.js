...
<div class="space-y-8 text-slate-700">
  ...
  <section>
    ...
    <ul>
      <li>
        <strong>1. What is Vertigo?</strong>
      ...
      <li>
        <strong>2. Which conditions cause Vertigo?</strong>
      ...
      <li>
        <strong>3. What are the types of Vertigo?</strong>
      ...
      <li>
        <strong>4. What are symptoms of Vertigo?</strong>
      ...
      <li>
        <strong>5. What are the tests done for Vertigo?</strong>
      ...
      <li>
        <strong>6. What is the treatment of vertigo?</strong>
      ...
      <li>
        <strong>7. Which doctor to do I need to consult?</strong>
