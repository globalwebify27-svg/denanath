...
<section>
  ...
  <div class="space-y-2">
    <div class="faq-item group cursor-pointer p-3 rounded-xl hover:bg-white hover:shadow-md transition-all duration-300 border border-transparent hover:border-slate-100">
      ...
      <div class="pl-8 text-slate-600 max-h-0 opacity-0 overflow-hidden group-hover:max-h-[1000px] group-hover:opacity-100 group-hover:mt-3 transition-all duration-500 ease-in-out">
    ...
    <div class="faq-item group cursor-pointer p-3 rounded-xl hover:bg-white hover:shadow-md transition-all duration-300 border border-transparent hover:border-slate-100">
      ...
      <div class="pl-8 text-slate-600 space-y-3 max-h-0 opacity-0 overflow-hidden group-hover:max-h-[1000px] group-hover:opacity-100 group-hover:mt-3 transition-all duration-500 ease-in-out">
        <div class="flex items-start gap-3">
...
async function main() {
  ...
  console.log("Successfully updated FAQs for Head and Neck Oncosurgery with hover UI");
}
