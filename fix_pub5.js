...
async function patch() {
  try {
    ...
    // Check if the 2021-2022 heading is already injected
    if (val.content.includes('Publications: April 2021 &ndash; March 2022')) {
      console.log('Already injected.');
      return;
    }

    const searchTarget = 'Localized surgical debridement for the management of orbital mucormycosis';
    ...
    if (idx !== -1) {
      ...
      if (divIdx !== -1) {
        val.content = val.content.substring(0, divIdx) + '<h4 class="text-base md:text-lg font-bold text-[#002b5c] mb-6 mt-12 border-t border-slate-100 pt-8">Publications: April 2021 &ndash; March 2022</h4>\n      ' + val.content.substring(divIdx);
        ...
        console.log("Successfully injected the 2021-2022 header!");
      } else {
