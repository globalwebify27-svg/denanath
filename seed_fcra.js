...
const fcraData = {
  "introduction": "Information regarding receipt of Foreign Contribution",
  "quarters": [
    {
    ...
    },
    {
      ...
      "donations": [],
      "emptyMessage": "Donations not received during Quarter 1 - FY 2023-24."
    },
    {
    ...
    },
    {
      ...
      "donations": [],
      "emptyMessage": "Donations not received during Quarter 2 - FY 2022-23"
    },
    {
    ...
    },
    {
      ...
      "donations": [
        ...
        {
          "name": "Alcon Vision, LLC, 6201 South Freeway, Fort Worth TX 76134, USA",
          "inr": "11,70,013/-",
          "date": "31/03/2022",
          "purpose": "Medical"
        }
    ...
    },
    {
      ...
      "donations": [],
      "emptyMessage": "Donations not received during Quarter 3 - FY 2018-19"
    },
    {
...
async function main() {
  const jsonString = JSON.stringify(fcraData);
  await prisma.siteSetting.upsert({
    where: { key: 'page_foreign_contribution' },
    update: { value: jsonString },
    create: { key: 'page_foreign_contribution', value: jsonString }
  });
  console.log("Successfully seeded FCRA data.");
}
