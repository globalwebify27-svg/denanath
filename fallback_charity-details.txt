...
export default function CharityDetailsPage() {
  ...
  const charityData = [
    ...
    { month: "March 2026", indigent: "95", weaker: "553" },
    { month: "February 2026", indigent: "152", weaker: "563" },
    { month: "January 2026", indigent: "353", weaker: "942" },
    { month: "December 2025", indigent: "1109", weaker: "1094" },
    { month: "November 2025", indigent: "1421", weaker: "840" },
    { month: "October 2025", indigent: "1333", weaker: "759" },
    { month: "September 2025", indigent: "1307", weaker: "803" },
  ];
              ...
              <div className="mb-10">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-5 mb-10">
                  <div className="bg-gradient-to-br from-teal-50 to-emerald-50 border border-teal-100/60 rounded-2xl p-6 flex items-center gap-5 shadow-sm">
                    ...
                    <div>
                      <p className="text-teal-900 font-extrabold text-3xl mb-1">5,851</p>
                  ...
                  <div className="bg-gradient-to-br from-blue-50 to-indigo-50 border border-blue-100/60 rounded-2xl p-6 flex items-center gap-5 shadow-sm">
                    ...
                    <div>
                      <p className="text-blue-900 font-extrabold text-3xl mb-1">6,074</p>
